...
<flowgorithm fileversion="3.0">
    <attributes>
        <attribute name="name" value="RLC Devresi 3 Tekrarlı Döngü"/>
    </attributes>
    <function name="Main" type="None" variable="">
        ...
        <body>
            ...
            <for variable="sayac" start="1" end="3" direction="inc" step="1">
                <output expression="sayac &amp; &quot;. TEST DURUMU İÇİN DEĞERLERİ GİRİNİZ&quot;" newline="True"/>
                ...
                <if expression="alpha &gt; omega0">
                    <then>
                        <output expression="&quot;--&gt; SONUÇ: AŞIRI SÖNÜMLÜ (Overdamped)&quot;" newline="True"/>
                    </then>
                    <else>
                        <if expression="alpha == omega0">
                            <then>
                                <output expression="&quot;--&gt; SONUÇ: KRİTİK SÖNÜMLÜ (Critically Damped)&quot;" newline="True"/>
                            </then>
                            <else>
                                <output expression="&quot;--&gt; SONUÇ: EKSİK SÖNÜMLÜ / SALINIMLI (Underdamped)&quot;" newline="True"/>
                            </else>
                        </if>
                    </else>
                </if>
            ...
            <output expression="&quot;3 test tamamlandı, program sonlandırılıyor.&quot;" newline="True"/>
        </body>
    </function>
</flowgorithm>
